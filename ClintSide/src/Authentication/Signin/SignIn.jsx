...
const SignIn = ({logIn,setLog}) => {
 ...
 const {user,
    ...
    Signed}=useSelector((store)=>store.auth)
                  // on each cheange actually we are store thsat  in to an object
          ...
          // form submition and all   and moving in to log in seaction
...
const [isError, setError] = useState(null);
                            ...
                            // CHEACKING A the pass word and strength also   showing the password strength as well  or error
