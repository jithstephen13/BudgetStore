...
const Footer = () => {
  return (<footer className="bg-white z-20  dark:bg-gray-900 mt-4">
    <hr className='pb-4 pt-4'/>
  <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div className="md:flex md:justify-between">
        
        <div className="mb-6 flex justify-center items-center md:mb-0">
            <a href="###" className="flex items-center">
                <img src="https://res.cloudinary.com/dqgeth8jx/image/upload/v1680631886/BudgetApp/budget-store-website-favicon-color_jb6t16.png" className="h-8 mr-3" alt="budget Store  Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">budget Store </span>
            </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                        <a href="###" className="hover:underline">budget Store </a>
                    </li>
                    <li>
                        <a href="##" className="hover:underline">Budget Store</a>
                    </li>
            ...
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                        <a href="https://github.com/themesberg/budget Store " className="hover:underline ">Github</a>
                    </li>
                    <li>
    ...
    <div className="sm:flex flex flex-col sm:items-center sm:justify-between items-center gap-3 ">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">Budget Store</a>
        </span>
